...
export default function BudgetSummary({ budget, isLoading }: BudgetSummaryProps) {
  ...
  if (isLoading) {
    return (
      <Card className="bg-white rounded-xl shadow-md p-5 mb-6">
      ...
      <Card className="bg-white rounded-xl shadow-md p-5 mb-6">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-4 mb-5">
          <div className="bg-primary-50 rounded-lg p-4 flex-1">
            ...
            <p className="text-primary-600 text-xl font-bold">$0.00</p>
          </div>
          <div className="bg-red-50 rounded-lg p-4 flex-1">
            <p className="text-gray-500 text-sm mb-1">Expenses</p>
            <p className="text-destructive text-xl font-bold">$0.00</p>
          </div>
          <div className="bg-blue-50 rounded-lg p-4 flex-1">
            <p className="text-gray-500 text-sm mb-1">Remaining</p>
            <p className="text-blue-600 text-xl font-bold">$0.00</p>
          </div>
        </div>
        ...
        <p className="text-xs text-gray-500">100% of budget remaining</p>
      </Card>
    );
  }
  ...
  return (
    <Card className="bg-white rounded-xl shadow-md p-5 mb-6">
      ...
      <p className="text-xs text-gray-500">{remainingPercentage}% of budget remaining</p>
    </Card>
  );
}
