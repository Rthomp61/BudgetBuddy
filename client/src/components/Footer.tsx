...
export default function Footer() {
  ...
  return (
    <footer className="bg-white border-t border-gray-200 py-3 px-4 shadow-md dark:bg-gray-800 dark:border-gray-700">
      <div className="flex justify-around">
        <Link href="/">
          <button className={`flex flex-col items-center ${isActive("/") ? "text-primary-500" : "text-gray-500"}`}>
            <HomeIcon className={`h-5 w-5 ${isActive("/") ? "text-primary-500" : "text-gray-500"}`} />
        ...
        <Link href="/future">
          <button className={`flex flex-col items-center ${isActive("/future") ? "text-primary-500" : "text-gray-500"}`}>
            <CalendarIcon className={`h-5 w-5 ${isActive("/future") ? "text-primary-500" : "text-gray-500"}`} />
        ...
        <Link href="/settings">
          <button className={`flex flex-col items-center ${isActive("/settings") ? "text-primary-500" : "text-gray-500"}`}>
            <SettingsIcon className={`h-5 w-5 ${isActive("/settings") ? "text-primary-500" : "text-gray-500"}`} />
        ...
        <Link href="/profile">
          <button className={`flex flex-col items-center ${isActive("/profile") ? "text-primary-500" : "text-gray-500"}`}>
            <UserIcon className={`h-5 w-5 ${isActive("/profile") ? "text-primary-500" : "text-gray-500"}`} />
